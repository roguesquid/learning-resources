<script>
    ...
    import FormatsFilter from './FormatsFilter.svelte';
...
<Accordion multiple flush>
    <AccordionItem class="px-4" paddingFlush="py-2">
        ...
        <span slot="arrowdown">
            <ChevronDoubleDownOutline class="-me-0.5 h-3 w-3" />
        </span>
    ...
    <!-- migrado -->
    <AccordionItem class="px-4" paddingFlush="py-2">
        <span slot="header">Formatos</span>
        <div slot="arrowup">
            <ChevronDoubleUpOutline class="-me-0.5 h-3 w-3" />
        </div>
        <span slot="arrowdown">
    ...
    <AccordionItem class="px-4" paddingFlush="py-2">
        <span slot="header">Patrocinantes</span>
        <div slot="arrowup">
            <ChevronDoubleUpOutline class="-me-0.5 h-3 w-3" />
        </div>
        <span slot="arrowdown">
    ...
    <AccordionItem class="px-4" paddingFlush="py-2">
        <span slot="header">Períodos</span>
        <div slot="arrowup">
            <ChevronDoubleUpOutline class="-me-0.5 h-3 w-3" />
        </div>
        <span slot="arrowdown">
